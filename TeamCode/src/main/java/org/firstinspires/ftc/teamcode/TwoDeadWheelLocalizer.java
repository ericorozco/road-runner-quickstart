...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3872.974026323794; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1365.7525827438142; // x position of the perpendicular encoder (in tick units)
    }
